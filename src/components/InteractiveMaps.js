...
function InteractiveMaps({ onBack }) {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", height: "100vh", fontFamily: ""Inter", -apple-system, BlinkMacSystemFont, sans-serif" }}>

      {/* SECTION TAB BAR */}
      <div style={{ background: "#1a1a1a", padding: "0 40px", display: "flex", borderBottom: "1px solid #2a2a2a", flexShrink: 0 }}>
                ...
                {vietnamGeoData.features.map((feature, idx) => {
                  ...
                  return (
                    <path
                      ...
                      style={{ cursor: "pointer", transition: "all 0.2s", filter: isHovered ? "brightness(1.1)" : "none" }}
